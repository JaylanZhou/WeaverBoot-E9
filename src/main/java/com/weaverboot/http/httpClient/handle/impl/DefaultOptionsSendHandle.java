...
import com.weaverboot.http.httpClient.handle.inte.OptionsSendHandle;
...
public class DefaultOptionsSendHandle implements OptionsSendHandle {
    ...
    public String sendOptions(String url, String body, EncodeCondition encodeCondition, HttpContentTypeCondition httpContentTypeCondition) {
        ...
        try {
            ...
            httpOptions = HttpClientBuildTools.getHttpOptions(url,body,encodeCondition,httpContentTypeCondition,param,header);
